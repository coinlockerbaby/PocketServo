...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : ECAT_CS_Pin LCD_RES_Pin */
  GPIO_InitStruct.Pin = ECAT_CS_Pin|LCD_RES_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : ECAT_INT_Pin SYNC0_Pin SYNC1_Pin */
  GPIO_InitStruct.Pin = ECAT_INT_Pin|SYNC0_Pin|SYNC1_Pin;
